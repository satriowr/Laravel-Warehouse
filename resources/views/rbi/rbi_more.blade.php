                ...
                <div class="d-flex flex-row gap-5">
                    <div class="show-data" style="width:35%; ">
                        <div class="mb-3">
                            ...
                            <input readonly value="{{ $b->golongan }}" type="text" name="golongan"  class="form-control" id="nama-aset">
                        </div>
        
                        <div class="mb-3">
                            <label for="kode-aset" class="form-label">Kode Bidang Barang</label>
                            <input readonly value="{{ $b->kode_bidang_barang }}" type="text" name="kode_bidang_barang"  class="form-control" id="kode-aset" >
                        </div>
        
                        <div class="mb-3">
                            <label for="luas-aset" class="form-label">Nama Bidang Barang</label>
                            <input readonly value="{{ $b->nama_bidang_barang }}" type="text" name="nama_bidang_barang"  class="form-control" id="luas-aset" >
                        </div>
        
                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Jumlah</label>
                            <input readonly value="{{ $b->jumlah }}" type="number"  name="jumlah"  class="form-control" id="lokasi" >
                        </div>
        
                        <div class="mb-3">
                            <label for="alamat" class="form-label">harga</label>
                            <input readonly value="{{ $b->harga }}" type="number" name="harga"  class="form-control" id="tahun_pengadaan">
                        </div>
                    ...
                    <div class="show-data2" style="width:35%">
                        <div class="mb-3">
                            ...
                            <textarea readonly type="text" name="keterangan"  class="form-control" id="hak" >{{ $b->keterangan }}</textarea>
                        </div>
                    </div>
                </div>  
            @endforeach
