...
<body>
    <div class="sidebar">
        ...
        <a class="" href="/tracking"><i class="bi bi-door-open"> </i> &nbsp Lacak</a>
        <br>
        ...
        <a class="" href="/"><i class="bi bi-grid-1x2-fill"> </i> &nbsp Buku Inventaris</a>
    ...
    <div class="content" style="height: 1000px">
        <div class="main-content" style="margin-top:16px; margin-left:24px; margin-right:24px">
            ...
            @foreach ($kib_c as $b)
                ...
                <form action="/kib-c/edit/{{ $b->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="d-flex flex-row justify-content-end container-section gap-3" style="margin-top:32px; border-radius:4px;">
                            <div class="d-flex flex-row justify-content-end container-section gap-3" style="margin-top:32px; border-radius:4px;">
                                <div class="cancel mt-3">
                                    <a href="/kib-c/more/{{ $b->id }}" class="btn btn-danger">Batalkan</a>
                                </div>
                                <div class="edit mt-3">
                    ...
                    <div class="d-flex flex-row gap-5">
                        <div class="show-data" style="width:35%; ">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kondisi" value="{{ $b->kondisi }}" class="form-control" id="luas-aset" >
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $b->jumlah_lantai }}" name="jumlah_lantai"  class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Lokasi</label>
                                <textarea type="text" name="lokasi" value="{{ $b->lokasi }}"  class="form-control" id="tahun_pengadaan" style="height: 120px">{{ $b->lokasi }}</textarea>
                            </div>
        
                            <div class="mb-3">
                                <label for="tanggal_sertifikat" class="form-label">Tanggal Dokumen</label>
                                <input type="date" name="tanggal_dokumen" value="{{ $b->tanggal_dokumen }}" class="form-control" id="hak" >
                            </div>
                        ...
                        <div class="show-data2" style="width:35%">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nomor_dokumen" value="{{ $b->nomor_dokumen }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="penggunaan" class="form-label">Luas Tanah</label>
                                <input type="number" name="luas_tanah" value="{{ $b->luas_tanah }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="asal_usul" class="form-label">Luas Bangunan</label>
                                <input type="number" name="luas_bangunan" value="{{ $b->luas_bangunan }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="harga" class="form-label">Status Tanah</label>
                                <input type="text" name="status_tanah" value="{{ $b->status_tanah }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="harga" class="form-label">Kode Tanah</label>
                                <input type="text" name="kode_tanah" value="{{ $b->kode_tanah }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="harga" class="form-label">Asal-Usul</label>
                                <input type="text" name="asal_usul" value="{{ $b->asal_usul }}" class="form-control" id="hak" >
                            </div>
        
                            <label for="nomor_sertifikat" class="form-label">Harga</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp</span>
                                <input type="number" name="harga" value="{{ $b->harga }}" class="form-control" id="hak" >
                            </div>
        
                            <div class="mb-3">
                                <label for="keterangan" class="form-label">Keterangan</label>
                                <textarea type="text" name="keterangan" value="{{ $b->keterangan }}" class="form-control" id="tahun_pengadaan" style="height: 120px">{{ $b->keterangan }}</textarea>
                            </div>
                        </div>           
