...
<head>
    ...
    <title>Buku Inventaris | Jasa Sarana</title>
...
<body>
    <div class="sidebar">
        ...
        <a class="active" href="/bukuinventaris"><i class="bi bi-grid-1x2-fill"> </i> &nbsp Buku Inventaris</a>
        ...
        <div class="main-content" style="margin-top:16px; margin-left:24px; margin-right:24px">
            ...
            <div class="section-kedua">
                <div class="d-flex flex-row justify-content-between container-section" style="margin-top:32px; border-radius:4px;">
                    ...
                    <form action="/bukuinventaris/search" method="get">
                    ...
                    <table class="table table-striped table-bordered table-sm" cellspacing="0" style="table-layout: fixed;">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" scope="col" style="width:150px">Merk</th>
                            <th class="text-center" scope="col" style="width:150px">HPS</th>
                            <th class="text-center" scope="col" style="width:150px">Gambar</th>
                          ...
                          <tr>
                            ...
                            <td>
                                <?php
                                    if ($a->gambar == null) {
                                        ...
                                        ?>
                                        <img style="width:200px; max-height:200px" class="img-thumbnail img-fluid" src="{{ asset('storage/' . $a->gambar) }}" alt="" >
                                        <?php
                                    }
                                ?>
                            </td>
                            ...
                            <td>
                                <div class="action d-flex justify-content-center gap-2 mt-3">
                                    ...
                                    {{-- <a href="/bukuinventaris/more/{{ $a->id }}"> --}}
                                        <button type="button" disabled class="btn btn-warning">
                                            Lihat
                                        </button>
                                    {{-- </a> --}}
                                
                                    <a href="/bukuinventaris/delete/{{ $a->id }}">
