    ...
    <div class="content" style="height: 1000px">
        <div class="main-content" style="margin-top:16px; margin-left:24px; margin-right:24px">
            ...
            @foreach ($kib_e as $b)
                ...
                <form action="/kib-e/edit/{{ $b->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="d-flex flex-row justify-content-end container-section gap-3" style="margin-top:32px; border-radius:4px;">
                            <div class="d-flex flex-row justify-content-end container-section gap-3" style="margin-top:32px; border-radius:4px;">
                                <div class="cancel mt-3">
                                    <a href="/kib-e/more/{{ $b->id }}" class="btn btn-danger">Batalkan</a>
                                </div>
                                <div class="edit mt-3">
                    ...
                    <div class="d-flex flex-row gap-5">
                        <div class="show-data" style="width:35%; ">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pengarang_buku" value="{{ $b->pengarang_buku }}" class="form-control" id="luas-aset" >
                            </div>
            
                            <div class="mb-3">
                                <label for="lokasi" class="form-label">Penerbit Buku</label>
                                <input type="text" name="penerbit_buku" value="{{ $b->penerbit_buku }}" class="form-control" id="lokasi" >
                            </div>
            
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Jumlah</label>
                                <input type="number" name="jumlah" value="{{ $b->jumlah }}" class="form-control" id="tahun_pengadaan">
                            </div>
            
                            <div class="mb-3">
                                <label for="hak" class="form-label">Tahun Terbit</label>
                                <input type="number" name="tahun_terbit" value="{{ $b->tahun_terbit }}" class="form-control" id="hak" >
                            </div>
