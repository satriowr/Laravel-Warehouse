...
<body>
    ...
    <div class="content" style="height: 800px">
        <div class="main-content" style="margin-top:16px; margin-left:24px; margin-right:24px">
            ...
            <form action="/kib-b/insert" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="d-flex flex-row gap-5">
                    <div class="show-data" style="width:35%; ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="bahan"  class="form-control" id="luas-aset" >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="warna"  class="form-control" id="tahun_pengadaan">
                        </div>
                    ...
                    <div class="show-data2" style="width:35%">
                        <div class="mb-3">
                            ...
                            <input type="text" name="tipe"  class="form-control" id="hak" >
                        </div>

                        <div class="mb-3">
                            <label for="tanggal_sertifikat" class="form-label">Tahun</label>
                            <input type="number" name="tahun"  class="form-control" id="hak" >
                        </div>

                        <div class="mb-3">
                            <label for="tanggal_sertifikat" class="form-label">Jumlah</label>
                            <input type="number" name="jumlah"  class="form-control" id="hak" >
                        </div>
    
                        <label for="nomor_sertifikat" class="form-label">Harga Perkiraan Sendiri</label>
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Rp</span>
                            <input type="number" name="hps"  class="form-control" id="hak" >
                        </div>

                        <div class="mb-3">
                            <label for="nomor_sertifikat" class="form-label">No Inverntaris Lama</label>
                            <input type="number" name="nomor_inventaris_lama"  class="form-control" id="hak" >
                        </div>
    
                        <div class="mb-3">
                            <label for="penggunaan" class="form-label">Keterangan</label>
                            <textarea type="text" name="keterangan"  class="form-control" id="hak" ></textarea>
                        </div>
