            ...
            <div class="d-flex flex-row gap-5">
                    <div class="show-data" style="width:35%; ">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_aset" value="{{ $b->nama_aset }}" class="form-control" id="nama-aset"   readonly>
                        </div>

                        <div class="mb-3">
                            <label for="kode-aset" class="form-label">Kode Aset</label>
                            <input type="text" name="kode_aset" value="{{ $b->kode_aset }}" class="form-control" id="kode-aset"   readonly>
                        </div>

                        <div class="mb-3">
                            <label for="luas-aset" class="form-label">Bahan</label>
                            <input type="text" name="bahan" value="{{ $b->bahan }}" class="form-control" id="luas-aset"   readonly>
                        </div>

                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi</label>
                            <input type="text" name="lokasi" value="{{ $b->lokasi }}" class="form-control" id="lokasi"   readonly>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="form-label">Warna</label>
                            <input type="text" name="warna" value="{{ $b->warna }}" class="form-control" id="tahun_pengadaan"  readonly>
                        </div>

                        <div class="mb-3">
                            <label for="hak" class="form-label">Merk</label>
                            <input type="text" name="merk" value="{{ $b->merk }}" class="form-control" id="hak"  readonly>
                        </div>
                    ...
                    <div class="show-data2" style="width:35%">
                        <div class="mb-3">
                            ...
                            <input type="text" name="tipe" value="{{ $b->tipe }}" class="form-control" id="hak" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_sertifikat" class="form-label">Tahun</label>
                            <input type="number" name="tahun" value="{{ $b->tahun }}" class="form-control" id="hak" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="keterangan" class="form-control" id="hak" style="height: 120px" readonly>{{ $b->keterangan }}</textarea>
                        </div>
                    </div>
                @endforeach
            </div>
