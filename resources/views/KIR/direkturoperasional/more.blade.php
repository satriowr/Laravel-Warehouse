...
<head>
    ...
    <title>Direktur Operasionaldirektoperasional | Warehouse</title>
        ...
        <div class="main-content" style="margin-top:16px; margin-left:24px; margin-right:24px">
            <div class="section-satu">
                ...
                <div class="select-kir d-flex flex-row justify-content-end">
                    <div class="back">
                        <a href="/kir/direkturoperasional">
            ...
            @foreach ($direkturoperasional as $a)
            <div class="form-insert">
                <div class="d-flex flex-row gap-5">
                    <div class="show-data1" style="width:35%">
                        <div class="mb-3">
                            <label for="tanggal_sertifikat" class="form-label">Jenis Aset/Nama Aset</label>
                            <input type="text" name="nama_aset" value="{{ $a->nama_aset }}" readonly  class="form-control" id="hak" >
                        </div>
    
                        <div class="mb-3">
                            <label for="nomor_sertifikat" class="form-label">Kode Aset</label>
                            <input type="text" name="kode_aset" value="{{ $a->kode_aset }}" readonly  class="form-control" id="hak" >
                        </div>
    
                        <div class="mb-3">
                            <label for="penggunaan" class="form-label">Merk/Model</label>
                            <input type="text" name="merk" value="{{ $a->merk }}" readonly class="form-control" id="hak" >
                        </div>
    
                        <div class="mb-3">
                            <label for="asal_usul" class="form-label">Ukuran</label>
                            <input type="text" name="ukuran" value="{{ $a->ukuran }}" readonly class="form-control" id="hak" >
                        </div>
                        <div class="mb-3">
                            <label for="asal_usul" class="form-label">Bahan</label>
                            <input type="text" name="bahan" value="{{ $a->bahan }}" readonly class="form-control" id="hak" >
                        </div>
                        <div class="mb-3">
                            <label for="asal_usul" class="form-label">Tahun Pembelian</label>
                            <input type="number" name="tahun_pembelian" value="{{ $a->tahun_pembelian }}" readonly class="form-control" id="hak" >
                        </div>
                    </div>
                    <div class="show-data2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="harga" value="{{ $a->harga }}" readonly class="form-control" id="hak" >
                        </div>
                        <div class="mb-3">
                            <label for="kondisi" class="form-label">Kondisi</label>
                            <select disabled name="kondisi" class="form-select" aria-label="Default select example">
                                <option selected>Pilih Kondisi</option>
                                <option <?php if($a->kondisi=="Baik (B)") echo 'selected="selected"'; ?> value="Baik (B)">Baik (B)</option>
                                <option <?php if($a->kondisi=="Kurang Baik (KB)") echo 'selected="selected"'; ?> value="Kurang Baik (KB)">Kurang Baik (KB)</option>
                                <option <?php if($a->kondisi=="Rusak Berat (RB)") echo 'selected="selected"'; ?> value="Rusak Berat (RB)">Rusak Berat (RB)</option>
                            </select>
                        </div>
                    </div>
                </div>
