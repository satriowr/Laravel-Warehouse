                          ...
                          <tr>
                            ...
                            <td>
                                <div class="action d-flex justify-content-center gap-2 mt-3">
                                    ...
                                    <a href="/kir/lounge/more/{{ $a->id }}">
                                        <button type="button" class="btn btn-warning">
                                            Lihat
                                        </button>
                                    </a>
                                
                                    <a href="/kir/lounge/delete/{{ $a->id }}">
